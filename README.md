...
This Demo Application is built with traditional MVC architecture using Spring Framework 5 with SpringBoot 2.0.0.M5, Hibernate 5, MongoDB and Gradle Build Tool